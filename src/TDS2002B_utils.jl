...
function update_scope_conf!(scope_conf, scope, refresh_cnt, base)	 
     ...
     #(refresh_cnt==base*3) && (scope_conf.Measurement_Value1 = get_meas_data(scope, "Meas_Nr1"))
     #(refresh_cnt==base*4) && (scope_conf.Measurement_Value2 = get_meas_data(scope, "Meas_Nr2"))
